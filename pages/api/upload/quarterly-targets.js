        ...
        await client.query(
          `INSERT INTO customer_quarterly_targets
           ...
           ON CONFLICT (customer_id, year) DO UPDATE SET
             ...
             q1_target = EXCLUDED.q1_target, q1_actual = EXCLUDED.q1_actual, q1_credit = EXCLUDED.q1_credit,
             q2_target = EXCLUDED.q2_target, q2_actual = EXCLUDED.q2_actual, q2_credit = EXCLUDED.q2_credit,
             q3_target = EXCLUDED.q3_target, q3_actual = EXCLUDED.q3_actual, q3_credit = EXCLUDED.q3_credit,
             q4_target = EXCLUDED.q4_target, q4_actual = EXCLUDED.q4_actual, q4_credit = EXCLUDED.q4_credit,
          ...
          [
            ...
            r.q3_target, r.q3_actual, r.q3_credit, r.q4_target, r.q4_actual, r.q4_credit,
