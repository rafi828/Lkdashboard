...
export default async function handler(req, res) {
  ...
  const data = rows.map((r) => ({
    ...r,
    q1_target: Number(r.q1_target), q1_actual: Number(r.q1_actual),
    q2_target: Number(r.q2_target), q2_actual: Number(r.q2_actual),
    q3_target: Number(r.q3_target), q3_actual: Number(r.q3_actual),
    q4_target: Number(r.q4_target), q4_actual: Number(r.q4_actual),
